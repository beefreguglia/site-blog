      ...
      <div className="flex flex-col items-center gap-12">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {customerStories.map((customer) => (
            <div key={customer.id} className="flex flex-col gap-6 rounded-lg bg-gray-500 p-6 md:p-12">
              <p className="text-balance text-gray-200">{customer.content}</p>

              <div className="flex items-center gap-3">
                <div className="relative size-12 overflow-hidden rounded-full border border-blue-200">
                  <Image
